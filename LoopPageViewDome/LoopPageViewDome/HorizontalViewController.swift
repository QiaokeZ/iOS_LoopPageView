...
class HorizontalViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        loopPageView.waitTimeInterval = 2
...
extension HorizontalViewController: LoopPageViewDataSource, LoopPageViewDelegate {
    ...
    func loopPageView(_ loopPageView: LoopPageView, scrollViewDidScroll scrollView: UIScrollView) {
        let index = Int(scrollView.contentOffset.x / scrollView.bounds.size.width + 0.5) % itemCount
        print("滑动到\(index)")
    }
